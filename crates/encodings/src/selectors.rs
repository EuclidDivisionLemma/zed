        ...
        pub fn new(
            ...
            EncodingSelectorDelegate {
                ...
                encodings: vec![
                    ...
                    StringMatchCandidate::new(1, "IBM866"),
                    StringMatchCandidate::new(2, "ISO 8859-1"),
                    StringMatchCandidate::new(3, "ISO 8859-2"),
                    StringMatchCandidate::new(4, "ISO 8859-3"),
                    StringMatchCandidate::new(5, "ISO 8859-4"),
                    StringMatchCandidate::new(6, "ISO 8859-5"),
                    StringMatchCandidate::new(7, "ISO 8859-6"),
                    StringMatchCandidate::new(8, "ISO 8859-7"),
                    StringMatchCandidate::new(9, "ISO 8859-8"),
                    StringMatchCandidate::new(10, "ISO 8859-10"),
                    StringMatchCandidate::new(11, "ISO 8859-13"),
                    StringMatchCandidate::new(12, "ISO 8859-14"),
                    StringMatchCandidate::new(13, "ISO 8859-15"),
                    StringMatchCandidate::new(14, "ISO 8859-16"),
                    ...
                    StringMatchCandidate::new(20, "Windows-1250"),
                    StringMatchCandidate::new(21, "Windows-1251"),
                    StringMatchCandidate::new(22, "Windows-1252"),
                    StringMatchCandidate::new(23, "Windows-1253"),
                    StringMatchCandidate::new(24, "Windows-1254"),
                    StringMatchCandidate::new(25, "Windows-1255"),
                    StringMatchCandidate::new(26, "Windows-1256"),
                    StringMatchCandidate::new(27, "Windows-1257"),
                    StringMatchCandidate::new(28, "Windows-1258"),
                    StringMatchCandidate::new(29, "Windows-949"),
                    StringMatchCandidate::new(30, "EUC-JP"),
                    StringMatchCandidate::new(31, "ISO 2022-JP"),
                    StringMatchCandidate::new(32, "GBK"),
                    StringMatchCandidate::new(33, "GB18030"),
                    StringMatchCandidate::new(34, "Big5"),
                ],
                matches: Vec::new(),
                selector,
                buffer,
